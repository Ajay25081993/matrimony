...
const AcceptedReceivedInterests = ({
  loggedInUserData,
  acceptedReceivedInterests,
}) => {
  ...
  return (
    <div className="w-2xl">
      ...
      <p className=" text-2xl font-semibold">
        {acceptedReceivedInterests?.length > 0
          ? `Interests that were accepted (${acceptedReceivedInterests.length})`
          : "No interests were accepted"}
      </p>
      {acceptedReceivedInterests?.length > 0 ? (
        <div>
          {acceptedReceivedInterests?.map((data, index) => {
            return (
              <div
                key={index}
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex flex-col mt-15 space-y-2">
                    <p className="font-semibold">
                      You accepted{" "}
                      {data.receiver.gender === "Male" ? "his" : "her"} interest
...
export default AcceptedReceivedInterests;
